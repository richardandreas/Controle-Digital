...
#include <Servo.h>
    ...
    float kpVertical = 0.23;
    float kiVertical = 0.000000023; // Quanto maior o ki, mais lento a reação do servo
    float kdVertical = 0.00000023; // Quanto maior o kd, mais instável o movimento do servo

    float kpHorizontal = 0.23;
    float kiHorizontal = 0.00000023;
    float kdHorizontal = 0.0000023;
